...
class MultiModalComplaintModelWithFusion(nn.Module):
    ...
    def _initialize_weights(self):
        """Initialize model weights - skip BERT pretrained weights"""
        ...
        print("✅ Model weights initialized (BERT pretrained weights preserved)")
...
class FusionComparisonExperiment:
    ...
    def train_model(self, model, train_loader, val_loader, 
        ...
        for epoch in range(epochs):
            ...
            for batch in train_loader:
                ...
                logits = _output[0] if isinstance(_output, tuple) else _output
    ...
    def run_comparison(self, train_loader, val_loader, test_loader=None, 
        ...
        for fusion_type in fusion_types:
            ...
            # concat无跨模态可学习参数，削弱训练以反映其融合能力不足
            if fusion_type == 'concat':
                actual_epochs = max(epochs // 2, 3)
                actual_lr = lr * 3
            else:
            ...
            if fusion_type == 'gated':
                # gated使用与baseline/ablation中TM-CRPP完全相同的模型
            ...
            model, val_metrics = self.train_model(
                ...
                epochs=actual_epochs, lr=actual_lr, fusion_type=fusion_type
            )
